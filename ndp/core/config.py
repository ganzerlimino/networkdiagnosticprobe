...
class NdpConfig:
    ...
    ui_button_debounce_seconds: float = 0.1
    ui_hint_edge: str = "left"
    ui_content_margin_side: int = 32
    ui_content_text_gap: int = 4
    ...
    def from_mapping(cls, data: dict[str, Any]) -> NdpConfig:
        ...
        return cls(
            ...
            ui_font_size=int(ui.get("font_size", 16)),
            ...
            ui_button_debounce_seconds=float(ui.get("button_debounce_seconds", 0.1)),
            ui_hint_edge=str(ui.get("hint_edge", "left")),
            ui_content_margin_side=int(ui.get("content_margin_side", 32)),
            ui_content_text_gap=int(ui.get("content_text_gap", 4)),
